...
import { Database, Plus, Save, Loader2, Search, CheckCircle2, FileText, UploadCloud, BrainCircuit, X, CalendarDays, Layers } from "lucide-react";
import { addCurrentAffair, bulkAddCurrentAffairs, fetchRecentCurrentAffairs, CurrentAffair } from "@/lib/currentAffairs";
                ...
                <div className="p-8 overflow-y-auto space-y-6 flex-1 custom-scrollbar">
                   {isLoading ? (
                     ...
                     affairsList.map(affair => (
                       <div key={affair.id} className="bg-black/40 rounded-3xl p-6 border border-white/5 shadow-inner hover:border-white/10 transition-colors">
